...
@elseif($modality_name == 'Reprogramación Largo Plazo con Garantía Personal Sector Activo con un Garante' || 
        $modality_name == 'Reprogramación Largo Plazo con Garantía Personal Sector Activo con dos Garantes' || 
        $modality_name == 'Reprogramación Largo Plazo con Pago Oportuno'|| 
        $modality_name == 'Reprogramación Largo Plazo Sector Pasivo Gestora Pública' ||
        $modality_name == 'Reprogramación Largo Plazo Sector Pasivo SENASIR' ||
        $modality_name == 'Reprogramación del Refinanciamiento Largo Plazo Sector Activo con un Garante' || 
        $modality_name == 'Reprogramación del Refinanciamiento Largo Plazo Sector Activo con dos Garantes' ||
        $modality_name == 'Reprogramación del Refinanciamiento Largo Plazo con Pago Oportuno' ||
        $modality_name == 'Reprogramación del Refinanciamiento Largo Plazo Sector Pasivo Gestora Pública' ||
        $modality_name == 'Reprogramación del Refinanciamiento Largo Plazo Sector Pasivo SENASIR'
        )
...
<div>
    ...
    <div>
        ...
        y por otra parte en calidad de PRESTATARIO el señor {{ $lender->full_name }} de generales ya señaladas, asi mismo en calidad de garantes personales 
        @if(count($guarantors) > 1)
        ...
        @endforeach
        damos nuestra plena conformidad con todas y cada una de las cláusulas precedentes, obligándonos a su fiel y estricto cumplimiento. En señal de lo cual suscribimos la presente adenda al contrato de préstamo de dinero 
