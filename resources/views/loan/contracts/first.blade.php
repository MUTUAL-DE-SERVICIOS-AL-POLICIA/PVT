...
<body>
    ...
    <div class="block text-justify">
        ...
        <div>
            ...
            {{ $employees[1]['identity_card'] }}, que para fines de este contrato en adelante se denominará MUSERPOL o
            ACREEDOR con domicilio en la Z. Sopocachi, Av. 6 de Agosto Nº 2354 y por otra parte
            @if (count($lenders) == 1)
                @php
                    $lender = $lenders[0];
        ...
        <div>
            ...
            {{ round($loan->interest->annual_interest) }}% anual sobre saldo deudor, el mismo que se recargará con el
            interés penal en caso de mora de una o más amortizaciones.
        </div>
        <div>
            <b>CUARTA.- (DEL PLAZO Y LA CUOTA DE AMORTIZACIÓN):</b> El plazo fijo e improrrogable para el cumplimiento
            de la obligación contraída por el PRESTATARIO en virtud al préstamo otorgado es de {{ $loan->loan_term }}
            {{ $loan->loan_term == 1 ? 'mes' : 'meses' }} computables a partir de la fecha
            de desembolso. La cuota de amortización mensual es de Bs.{{ Util::money_format($loan->estimated_quota) }}
        ...
        <div>
            ...
            reconociendo ambas partes que al amparo de este procedimiento se cumple satisfactoriamente la exigencia
            contenida en el artículo 1331 del Código de Comercio.
        </div>
        <div>
            ...
            {{ $type_rent }} que percibe en forma mensual a través del {{ $discount_entity }} conforme al Reglamento de Préstamos.
        </div>
        <div>
            Si por cualquier motivo la MUSERPOL estuviera imposibilitada de realizar el descuento por el medio señalado,
            el PRESTATARIO se obliga a cumplir con la cuota de amortización mediante pago directo en la Oficina Central de la MUSERPOL
            de la ciudad de La Paz o efectuar el depósito bancario en la cuenta fiscal de la MUSERPOL. Caso contrario el PRESTATARIO se
            hará pasible al recargo correspondiente a los intereses que se generen al día de pago por la deuda contraída.
        </div>
        <div>
            Asimismo, el PRESTATARIO se compromete hacer conocer oportunamente a la MUSERPOL sobre la omisión del
            descuento mensual que se hubiera dado, sin perjuicio que realice el depósito directo del mes omitido, de acuerdo a lo estipulado en
            el párrafo precedente. Caso contrario se procedera al descuento
            {{ count($guarantors) > 1 ? 'de los garantes personales' : 'del garante personal' }} incluido
            los intereses penales una vez transcurrido dos cuotas impagas, sin necesidad de previo aviso.
        </div>
        <div>
            <b>SÉPTIMA.- (DERECHOS DEL PRESTATARIO):</b> Conforme al Artículo 10 del Reglamento de Préstamos las partes
            reconocen expresamente como derechos del PRESTATARIO, lo siguiente:
        </div>
        <div>
            <ol type="a" style="margin:0;">
                <li>
                    Recibir buena atención, trato equitativo y digno por parte de los funcionarios de la MUSERPOL sin
                    discriminación de ninguna naturaleza, asimismo recibir información y orientación precisa, comprensible, oportuna y
                    accesible con relación a requisitos, características y condiciones del préstamo.
                </li>
                <li>
        ...
        <div>
            ...
            <ol type="a" style="margin:0;">
                <li>Proporcionar información y documentación veraz y legítima para la correcta tramitación del préstamo.
                </li>
                ...
                <li>
                    ...
                    capital adeudado y los intereses
                    correspondientes según contrato de préstamo suscrito.
                </li>
            </ol>
        </div>
        <div>
            <div <b>NOVENA.- (DE LA GARANTÍA):</b>El PRESTATARIO y
                {{ count($guarantors) > 1 ? 'GARANTES' : 'GARANTE' }}, garantizan el pago
                de lo adeudado con la generalidad de sus bienes, derechos y acciones habidos y por haber, presentes y
                futuros conforme lo determina el artículo 1335 del Código Civil y además el PRESTATARIO con los beneficios otorgados por
                la MUSERPOL.
            </div>
            <div>
                Asimismo se
                {{ count($guarantors) > 1
                    ? 'constituyen como garantes personales, solidarios, mancomunados, e indivisibles'
                ...
                @foreach ($guarantors as $key => $guarantor)
                    <span>
                        ...
                        natural de {{ $guarantor->city_birth->name }},
                        vecin{{ Util::male_female($guarantor->gender) }} de {{ $guarantor->address->cityName() }}
                        y con domicilio en
                ...
                sus haberes en calidad de {{ count($guarantors) > 1 ? 'GARANTES,' : 'GARANTE,' }}
            ...
            <div>
                <b>DÉCIMA.- (MODIFICACIÓN DE LA SITUACIÓN DEL PRESTATARIO):</b> El PRESTATARIO en caso de fallecimiento,
                ...
                adeudado, se continuará con el descuento {{ count($guarantors) > 1 ? 'a los GARANTES' : 'al GARANTE' }}
                el saldo deudor que quedare pendiente.
            </div>
            <div>
            ...
            <div>
                ...
                la MUSERPOL y reconocidos al PRESTATARIO, conforme al artículo 83 del Reglamento de Préstamos.
            </div>
            <div>
            ...
            <div>
                ...
                y novena de conformidad al artículo 29 parágrafo II del Código Civil, donde se efectuarán las citaciones y notificaciones
                judiciales o cualquier otra comunicación, con plena validez legal y sin lugar a posterior observación o recurso alguno.
            </div>
            <div>
                <b>DÉCIMA CUARTA.- (DE LA CONFORMIDAD Y ACEPTACIÓN):</b> Por una parte en calidad de ACREEDOR la Mutual de Servicios
                ...
                @if (count($lenders) == 1)
                    <span>PRESTATARIO{{ $lender->gender == 'M' ? '' : 'A' }}
                        {{ $lender->gender == 'M' ? 'el Sr.' : 'la Sra' }}
                    ...
                    @foreach ($guarantors as $key => $guarantor)
                        <span>
                            {{ $guarantor->gender == 'M' ? 'el Sr.' : 'la Sra' }}
                            {{ $guarantor->full_name }}{{ $key == 0 ? $sw : ',' }}
                        </span>
                    @endforeach
                    damos nuestra plena conformidad con todas y cada una de las cláusulas precedentes, obligándonos a su fiel y estricto
                    cumplimiento. En señal de lo cual suscribimos el presente contrato {{ $title }}
    ...
    @else
        ...
        <div class="block text-justify">
            <div>
                Conste en el presente contrato de préstamo de {{ ucfirst($title) }}, que al solo reconocimiento de
                firmas y
            ...
            <div>
                ...
                Servicios
                al Policía (MUSERPOL), representada legalmente por su {{ $employees[0]['position'] }}
                {{ $employees[0]['name'] }}
                con C.I. {{ $employees[0]['identity_card'] }} y su {{ $employees[1]['position'] }}
                {{ $employees[1]['name'] }}
                con C.I. {{ $employees[1]['identity_card'] }}, que para fines de este contrato en adelante se
                denominará MUSERPOL
                ...
                @if (count($lenders) == 1)
                    ...
                    <span>
                        {{ $lender->gender == 'M' ? 'el Sr.' : 'la Sra' }} {{ $lender->full_name }}, con C.I.
                        {{ $lender->identity_card }}, {{ $lender->civil_status_gender }}, mayor de edad, hábil por
                        derecho, natural de
                        {{ $lender->city_birth->name }}, vecin{{ $male_female }} de
                        {{ $lender->address->cityName() }} y con domicilio en
                        {{ $lender->address->full_address }}, en adelante denominad{{ $male_female }} PRESTATARIO.
                    </span>
                @endif
            </div>
            <div>
                ...
                Bs.{{ Util::money_format($loan->amount_approved) }} (<span
                    class="uppercase">{{ Util::money_format($loan->amount_approved, true) }}
                    Bolivianos</span>).
            </div>
            <div>
                <b>TERCERA.- (DEL INTERÉS):</b> El préstamo objeto del presente contrato, devengará un interés ordinario
                del
                {{ $loan->interest->annual_interest }}% anual sobre saldo deudor, el mismo que se recargará con el
                interés penal
                en caso de mora de una o más amortizaciones.
            </div>
            <div>
                <b>CUARTA.- (DEL PLAZO Y LA CUOTA DE AMORTIZACIÓN):</b> El plazo ﬁjo e improrrogable para el
                cumplimiento de la
                obligación contraída por el PRESTATARIO en virtud al préstamo otorgado es de {{ $loan->loan_term }}
                meses computables
                a partir de la fecha de desembolso. La cuota de amortización mensual es de
                Bs.{{ Util::money_format($loan->estimated_quota) }}
                (<span class="uppercase">{{ Util::money_format($loan->estimated_quota, true) }} Bolivianos).</span>
            </div>
            <div>
            ...
            <div>
                <b>QUINTA.- (DEL DESEMBOLSO):</b> El desembolso del préstamo de dinero en la moneda pactada se acredita
                mediante
                comprobante escrito en el que conste el abono efectuado a favor del PRESTATARIO, a través de una cuenta
                bancaria
                señalada por el mismo, reconociendo ambas partes que al amparo de este procedimiento se cumple
                satisfactoriamente
            ...
            <div>
                ...
                @if (
                    $modality_name == 'Largo Plazo con Garantía Personal Sector Pasivo AFP' ||
                        $modality_name == 'Largo Plazo con Garantía Personal Sector Pasivo Gestora Pública')
                    <b>SEXTA.- (DE LA FORMA DE PAGO Y OTRAS CONTINGENCIAS):</b> Para el cumplimiento estricto de la
                    obligación
                    (capital e intereses) el PRESTATARIO, se obliga a cumplir con la cuota de amortización en forma
                    mensual
                    mediante pago directo en la oﬁcina central de la MUSERPOL de la ciudad de La Paz o efectuar el
                    depósito
                    en la cuenta fiscal de la MUSERPOL. Caso contrario el PRESTATARIO se hará pasible al recargo
                    correspondiente
                    a los intereses que se generen al día de pago por la deuda contraída y consecuentemente se procederá
                    al
                    descuento al garante personal incluido los intereses penales una vez transcurrido dos cuotas
                    impagas,
                ...
                @else
                    ...
                    <b>SEXTA.- (DE LA FORMA DE PAGO Y OTRAS CONTINGENCIAS):</b> Para el cumplimiento estricto de la
                    obligación
                    (capital e intereses) el PRESTATARIO, autoriza expresamente a la MUSERPOL practicar los descuentos
                    respectivos
                    {{ $renta }} que percibe en forma mensual a través del {{ $sexta }} conforme al
                    Reglamento de Préstamos.
                    <div>
                        Si por cualquier motivo la MUSERPOL estuviera imposibilitada de realizar el descuento por el
                        medio señalado, el
                        PRESTATARIO se obliga a cumplir con la cuota de amortización mediante pago directo en la Oficina
                        Central de la MUSERPOL
                        de la ciudad de La Paz o efectuar el depósito en la cuenta fiscal de la MUSERPOL. Caso contrario
                        el PRESTATARIO se
                        hará pasible al recargo correspondiente a los intereses que se generen al día de pago por la
                        deuda contraída.
                    </div>
                    <div>
                        Asimismo, el PRESTATARIO se compromete hacer conocer oportunamente a la MUSERPOL sobre la
                        omisión del descuento
                        mensual que se hubiera dado, sin perjuicio que realice el depósito directo del mes omitido, de
                        acuerdo a lo estipulado en el párrafo precedente.
                        Caso contrario se procedera al descuento
                        {{ count($guarantors) > 1 ? 'de los garantes personales' : 'del garante personal' }}
                        incluido los intereses penales una vez transcurrido dos cuotas impagas, sin necesidad de previo
                        aviso.
                    </div>
                @endif
            </div>
            <div>
                ...
                partes reconocen expresamente
                como derechos del PRESTATARIO, lo siguiente:
            </div>
            <div>
                <ol type="a" style="margin:0;">
                    <li>
                        Recibir buena atención, trato equitativo y digno por parte de los funcionarios de la MUSERPOL
                        sin discriminación
                        de ninguna naturaleza, asimismo recibir información y orientación precisa, comprensible,
            ...
            <div>
                <ol type="a" style="margin:0;">
                    <li>Proporcionar información y documentación veraz y legítima para la correcta tramitación del
                        préstamo.</li>
                    <li>Cumplir con los requisitos, condiciones y lineamientos del préstamo.</li>
                    <li>Cumplir con el Contrato de Préstamo suscrito entre la MUSERPOL y el Prestatario.</li>
                    <li>
            ...
            <div>
                @if ($modality_name == 'Largo Plazo con Garantía Personal Sector Pasivo SENASIR')
                    <div>
                        <b>NOVENA.- (DE LA GARANTÍA):</b>El PRESTATARIO y GARANTE, garantizan el pago de lo adeudado con
                        la
                        generalidad de sus bienes, derechos y acciones habidos y por haber, presentes y futuros conforme
                        lo determina
                        el artículo 1335 del Código Civil, así como también con su renta de vejez en curso de pago,
                        asimismo este
                    ...
                    {{ count($guarantors) > 1
                        ...
                        : 'constituye como garante personal, solidario, mancomunado e indivisible' }}:
                @else
                    <b>NOVENA.- (DE LA GARANTÍA):</b>El PRESTATARIO y GARANTE{{ count($guarantors) > 1 ? 'S' : '' }},
                    garantizan el pago de lo adeudado con la
                    generalidad de sus bienes, derechos y acciones habidos y por haber, presentes y futuros conforme lo
                    determina
                    el artículo 1335 del Código Civil y además el PRESTATARIO con los beneficios otorgados por la
                    MUSERPOL.
                    <br>Asimismo se
                    {{ count($guarantors) > 1
                        ? 'constituyen como garantes personales, solidarios, mancomunados, 
                                                    e indivisibles'
                        : 'constituye como garante personal, solidario, mancomunado e indivisible' }}:
                @endif
                @foreach ($guarantors as $key => $guarantor)
                    <span>
                        {{ $guarantor->gender == 'M' ? 'el Sr.' : 'la Sra' }} {{ $guarantor->full_name }}, con C.I.
                        {{ $guarantor->identity_card }}, {{ $guarantor->civil_status_gender }}, mayor de edad, hábil
                        por
                        derecho, natural de {{ $guarantor->city_birth->name }},
                        vecin{{ Util::male_female($guarantor->gender) }} de
                        {{ $guarantor->address->cityName() }} y con domicilio en
                        {{ $guarantor->address->full_address }}
                ...
                @if ($modality_name == 'Largo Plazo con Garantía Personal Sector Pasivo SENASIR')
                    {{ count($guarantors) > 1
                        ? 'autorizan el descuento mensual de sus haberes'
                ...
                responsabilidad o reclamo posterior, sin perjuicio de que
                {{ count($guarantors) > 1 ? 'estos puedan' : 'este pueda' }}
                iniciar las acciones legales correspondientes en contra del PRESTATARIO.
            ...
            <div>
                @if (
                    $modality_name == 'Largo Plazo con Garantía Personal Sector Pasivo AFP' ||
                        ...
                        $modality_name == 'Largo Plazo con Garantía Personal Sector Pasivo Gestora Pública')
                    <div>
                        <b>DECIMA.- (CONTINGENCIAS POR FALLECIMIENTO):</b> El PRESTATARIO en caso de fallecimiento
                        acepta
                        amortizar para el cumplimiento efectivo de la presente obligación con el beneﬁcio del
                        Complemento
                        Económico
                        ...
                        cubrir el monto total de la obligación que resulte adeudada, más los intereses devengados a la
                        fecha,
                ...
                @else
                    <div>
                        ...
                        {{ count($guarantors) > 1 ? 'a los GARANTES' : 'al GARANTE' }} el saldo deudor que quedare
                        pendiente.
                    </div>
                @endif
            </div>
            <div>
                ...
                requerimiento alguno, de acuerdo a lo establecido por el artículo 341, Núm. 1) del Código Civil, al
                incumplimiento
                del pago de cualquier amortización de capital o intereses, sin necesidad de intimación o requerimiento
                alguno,
                o acto equivalente por parte de la MUSERPOL.
            </div>
            <div>
                Además del interés acordado contractualmente, el préstamo generará en caso de mora un interés moratorio
                anual del 6% sobre saldos de capital de las cuotas impagas, aún cuando fuere exigible todo el capital
                del préstamo.
            </div>
            <div>
                <b>DÉCIMA SEGUNDA.- (DE LOS EFECTOS DEL INCUMPLIMIENTO Y DE LA ACCIÓN EJECUTIVA):</b> El incumplimiento
                de
                pago mensual por parte del PRESTATARIO dará lugar a que la totalidad de la obligación, incluidos los
                intereses moratorios, se determinen líquidos, exigibles y de plazo vencido quedando la MUSERPOL
                facultada
                ...
                calidad de Título Ejecutivo, demandando el pago de la totalidad de la obligación contraída, más la
                cancelación
            ...
            <div>
                ...
                de la obligación, el PRESTATARIO no tendrá derecho a acceder a otro crédito, hasta la cancelación total
                de la deuda.
            </div>
            <div>
                <b>DÉCIMA TERCERA.- (DOMICILIO ESPECIAL):</b> Para efectos legales, incluida la acción judicial u otra,
                se tendrá como domicilio especial del PRESTATARIO y
                {{ count($guarantors) > 1 ? 'GARANTES' : 'GARANTE' }}
                el
            ...
            <div>
                ...
                de Servicios al Policía (MUSERPOL), representada por su {{ $employees[0]['position'] }}
                {{ $employees[0]['name'] }}
